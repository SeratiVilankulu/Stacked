...
export type StorageHash =
  StorageHashBase<'bf7155eaf448d0e6fad38216f24663aeed35d7769ae0c77d8aad704bfb9f1937'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Library: {
      ...
      readonly userId: CodecTypes['pg/uuid@1']['output'];
      readonly bookId: CodecTypes['pg/uuid@1']['output'];
      readonly status: 'WANT_TO_READ' | 'READING' | 'COMPLETED' | 'ABANDONED';
...
export namespace Models {
  export type public_User = {
    ...
    readonly [RelationKeys]?:
      'admins' | 'bookCopies' | 'fines' | 'library' | 'loanedBooks' | 'reservations';
  };
  export type public_Book = {
    ...
    reservations: public_Reservation[];
    readonly [RelationKeys]?:
      'admins' | 'bookCopies' | 'libraryEntries' | 'loanedBooks' | 'reservations';
  };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly library: {
              ...
              primaryKey: { readonly columns: readonly ['Id'] };
              uniques: readonly [{ readonly columns: readonly ['User_Id', 'Book_Id'] }];
              indexes: readonly [
                {
                  readonly name: 'library_User_Id_idx_99d17088';
                  readonly prefix: 'library_User_Id_idx';
                  readonly columns: readonly ['User_Id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'library_Book_Id_idx_f7bddef2';
                  readonly prefix: 'library_Book_Id_idx';
                  readonly columns: readonly ['Book_Id'];
                  readonly unique: false;
                },
              ];
          ...
          readonly valueSet: {
            ...
            readonly ReadingStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['WANT_TO_READ', 'READING', 'COMPLETED', 'ABANDONED'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly library: { readonly namespace: 'public' & NamespaceId; readonly model: 'Library' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
