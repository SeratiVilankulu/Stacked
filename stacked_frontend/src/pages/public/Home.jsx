				...
				<section className="relative mx-auto max-w-7xl px-6 pt-12 md:px-10 lg:pt-14">
					<div className="flex flex-col gap-2 items-center text-center max-w-4xl mx-auto">
						...
						<p className="w-140 max-w-2xl text-sm leading-6 text-teal md:text-base">
							...
							books, borrow your loaned books, and keep track of your reading
							library.
						</p>
						{/* Search bar */}
					...
					<div className="relative mx-auto mt-10 max-w-5xl">
						...
						{/* Library photo */}
						<div className="relative z-10 overflow-hidden rounded-l-[70px] rounded-r-[70px] shadow-card">
							<img
								src={Books}
								alt="Books and coffee in a library"
								className="h-75 w-full object-cover md:h-90 object-[20%_65%] z-10"
							/>
						</div>
						...
						<img
							...
							alt=""
							aria-hidden="true"
							className="pointer-events-none absolute -right-90 rotate-210 md:w-30"
						/>
					</div>
					<Features />
				</section>
